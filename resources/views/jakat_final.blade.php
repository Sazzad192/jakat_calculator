...
<html lang="bn">    
    ...
    <body id="main_body">
        <section class="pt-3">
            <div class="jakat-calculator-bg">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="jakat-title common-taitel text-left pb-2">
                                <h1>যাকাত ক্যালকুলেটর</h1>
                            </div>
                            <div class="jakat-subtitle justify-content-start ">
            ...
            <div class="container pt-2">
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        ...
                        <div class="form-group row py-2 jakat-body-input pb-4">
                            <label class="col-lg-4 col-form-label text-right name">যাকাত প্রদানকারীর নাম:</label>
                            <div class="col-lg-7">
                              <input type="text" class="form-control input-type text-left" id="inputgold" placeholder="যাকাত প্রদানকারীর নাম লিখুন">
                            </div>
                        </div>
